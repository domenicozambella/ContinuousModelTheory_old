...
\begin{lemma}\label{lem_HIapprox}
  ...
  \ceq{\hfill \big\{i\in I:{\EuScript M}\models\varphi(a_i\,; \alpha)\big\}\in F}
  {\Leftrightarrow}
...
\begin{proof}
  ...
  \ceq{\forall.\hfill \big\{i\in I:{\EuScript M}\models\forall y\,\varphi(a_i,y\,; \alpha)\big\}\in F}
  {\Leftrightarrow}
  {\big\{i\in I:{\EuScript M}\models\forall y\,\varphi(a_i,y\,;\alpha_i)\big\}\in F}.


  ($\forall\Rightarrow$) Negate the consequent and pick a sequence $\langle b_i:i\in I\rangle$ such that $\big\{ i:\neg\varphi(a_i,b_i\,;\alpha_i)\big\}\in F$. 
  From (\textsf{ih}) we obtain $\big\{i:\neg\varphi(a_i,b_i\,; \alpha)\big\}\in F$.
  This proves (\textsf{i}$\forall\Rightarrow$).

  ($\forall\Leftarrow$) Negate the consequent and pick a sequence $\langle b_i:i\in I\rangle$ such that $\big\{ i:\neg\varphi(a_i,b_i\,;\alpha)\big\}\in F$. 
  From (\textsf{ih}) we obtain $\big\{i:\neg\varphi(a_i,b_i\,; \alpha_i)\big\}\in F$.
  This proves (\textsf{i}$\forall\Leftarrow$).

  To deal with the existential quantifier of sort $M$ we prove 

  \ceq{\exists.\hfill \big\{i\in I:{\EuScript M}\models\exists y\,\varphi(a_i,y\,; \alpha)\big\}\in F}
  {\Leftrightarrow}
  {\big\{i\in I:{\EuScript M}\models\exists y\,\varphi(a_i,y\,;\alpha_i)\big\}\in F}.


  ($\exists\Rightarrow$) Assume the antecedent.
  Pick is a sequence $\langle b_i:i\in I\rangle$ such that $\big\{ i:\varphi(a_i,b_i\,;\alpha)\big\}\in F$.
  By (\textsf{ih})  we obtain $\big\{ i:\exists y\,\varphi(a_i,y\,;\alpha_i)\big\}\in F$.
  

  ($\exists\Leftarrow$) Assume the antecedent.
  Pick a sequence $\langle b_i:i\in I\rangle$ such that $\big\{ i:\varphi(a_i,b_i\,;\alpha_i)\big\}\in F$.
  By (\textsf{ih}) we obtain $\big\{ i:\exists y\,\varphi(a_i,y\,;\alpha)\big\}\in F$.
...
\begin{proof}  
  ...
  Then $F\mbox{-}\lim_it(\hat ai)\in C'$ for every neighborhood of $C$.
  By regularity, ${\EuScript N}\models t(\hat a)\in C$.
...
We say that $f:M\to N$, a partial map, is an \emph{$\mathds{L}$-elementary map\/} if for every $\varphi(x)\in\mathds{L}$

\ceq{\hfill{\EuScript M}\models\varphi(a)}{\Rightarrow}{{\EuScript N}\models\varphi(fa)}\hfill for every $a\in({\rm dom }f)^{|x|}$.

A total $\mathds{L}$-elementary map is called an \emph{$\mathds{L}$-(elementary) embedding.} 
If the map ${\rm id}_M:M\hookrightarrow N$ is an $\mathds{L}$-embedding, that is, if for every  $\varphi(x)\in\mathds{L}$

\ceq{\hfill{\EuScript M}\models\varphi(a)}{\Rightarrow}{{\EuScript N}\models\varphi(a)}\hfill for every $a\in M^{|x|}$,
...
We say that $f:M\to N$ is an \emph{approximatively $\mathds{L}$-elementary map\/} if for every $\varphi(x)\in\mathds{L}$ and every  $a\in({\rm dom }f)^{|x|}$
...
%   \end{itemize}
% \end{definition}
A model ${\EuScript N}$ is \emph{$\mathds{L}$-saturated\/} it realizes all types with fewer than $|{\EuScript N}|$ parameters that are finitely consistent in ${\EuScript N}$.
...
Note that the consistency of of the type $\{\exists y\,\varphi'(x,y):\varphi'>\varphi\}$ implies the finite concistency of $\{\varphi'(x,y):\varphi'>\varphi\}$.
...
Therefore \# follows by saturation.

\noindent\llap{\textcolor{red}{\Large\danger}\kern1ex}\ignorespaces
Consider the existential quantifiers of sort $R$\ldots
\end{proof}
...
\begin{corollary}
  If $\varphi(x),\psi(x)\in\mathds{L}(U)$ are mutually inconsistent then $\varphi'(x)$ and $\psi'(x)$ are mutually inconsistent for some $\varphi'>\varphi$ and $\psi'>\psi$.
\end{corollary}
