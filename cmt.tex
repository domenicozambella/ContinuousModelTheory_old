...
\begin{definition}\label{def_0}
  ...
  The language \emph{${\EuScript L}$\/} expands both $L$ and $L_R$ but only with function symbols of sort $M^n\to R$. 
\end{definition}
...
Let $R\preceq{}^*\!R$.
For $\alpha,\beta\in{}^*\!R$ we define the equivalence relation \emph{$\alpha\sim\beta$\/} as follows

\ceq{\hfill\alpha\sim\beta}{\Leftrightarrow}{{}^*\!R\ \models\ \alpha\in C\leftrightarrow\beta\in C}\quad for every compact $C\subseteq R$.

By compactness, every $\alpha\in{}^*\!R$ is equivalent to some element of $R$.
By normality, this element is unique.
...
\begin{proof}
  ...
  We prove that for every compact $C_i\subseteq R$ such that $C\subseteq C_1\times\dots\times C_{|y|}$

  \ceq{\hfill{\EuScript N}}
  {\models}
  {t_i(a\,;\alpha)\in C_i.}

  By the definition of product topology, $C$ is the intersection of such product sets.
  Hence${\EuScript N}\models t(a\,;\alpha)\in C$ follows. 
...
This proves lemma for $\mathds{L}$-atomic formulas.
