...
\begin{lemma}\label{lem_HIapprox}
  ...
  \ceq{\hfill\{i\in I:{\EuScript M}\models\varphi'(a_i;\alpha)\}\in F}{ ~}{\textrm{for every }\varphi'>\varphi;}

  \ceq{\hfill\{i\in I:{\EuScript M}\models\varphi'(a_i;\alpha_i)\}\in F}{~}{\textrm{for every }\varphi'>\varphi.}
\end{lemma}
\begin{proof}
