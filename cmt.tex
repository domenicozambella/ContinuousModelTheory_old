...
The axioms that the unit ball has to saisfy are in Definition~\ref{def_unitball}.
...
We write \emph{$M\equiv N$\/} when $\varnothing:U_M\to N$ is an elementary map and \emph{$M\equiv_A N$\/} if ${\rm id}_A:M\to N$ is an elementary map.
