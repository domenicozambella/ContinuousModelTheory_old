...
\begin{definition}\label{def_0}
  ...
  By \emph{model\/} we intend a structure as those described in this definition.
...
\begin{definition}\label{def_LL}
  Formulas in \emph{$\mathds{L}$\/} are constructed inductively from the following sets of \emph{$\mathds{L}$-atomic\/} formulas
  \begin{itemize}
