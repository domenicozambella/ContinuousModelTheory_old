...
These notes do not claim new mathematical results.
In fact, the main ideas applied here originated in the mid 20th century (cf. Chang-Keisler, Gromov).
...
We elaborate on this idea and generalize it to arbitrary structures.
We also show that their approach applies to a larger class of formulas.
...
\begin{definition}\label{def_0}
  ...
  The function symbols of $L'$ fall in one of two groups
  \begin{itemize}
