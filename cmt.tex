...
\begin{definition}\label{def_LL}
  ...
  \end{itemize}
  We require that $\mathds{L}$ is closed under the Boolean connectives $\wedge$, $\vee$; the quantifiers $\forall$, $\exists$ of sort $M$; and the quantifier $\forall^C$, by which we mean a universal quantifier restricted to the compact set $C\subseteq R^m$.
\end{definition}
...
\begin{fact}\label{fact_unifcont}
  ...
  Assume that for some $\alpha\in R^{|y|}$
  
  \ceq{\hfill\{i\in I : t^{\EuScript M}( a_i;\alpha)\in U\}}{\in}{F.}

  Then there is an open $V\ni\alpha$ such that for every $\alpha'\in V$
...
\begin{lemma}\label{lem_HIapprox}
  ...
  \ceq{\hfill\{i\in I:{\EuScript M}\models\varphi(a_i;\alpha)\}}{\in}{F.} 

  Then for every $\varphi'>\varphi$

  \ceq{\hfill\{i\in I:{\EuScript M}\models\varphi'(a_i\,;\alpha_i)\}}{\in}{F.} 
...
\begin{proof}
  ...
  Then $\{i:{\EuScript M}\models t'(a_i\,;\alpha_i)\in D\}\in F$ follows and proves the base case of the induction.
  ...
  Then $\big\{i:{\EuScript M}\models\varphi(a_i,b_i\,; \alpha)\big\}\in F$ and, by induction hypothesis, $\big\{ i:{\EuScript M}\models\varphi'(a_i,b_i\,;\alpha_i)\big\}\in F$. A contradiction that proves (1).
  
  Induction for the quantifier $\forall^B$ is virtually identical, but we repeat the argument for convenience.
  ...
  Then $\big\{i:{\EuScript M}\models\varphi(a_i\,; \alpha,\beta)\big\}\in F$ and, by induction hypothesis, $\big\{ i:{\EuScript M}\models\varphi'(a_i\,;\alpha_i,\beta_i)\big\}\in F$. A contradiction that proves (2) and, with it, the lemma.
\end{proof}
