...
Intuitively, the function symbols are divided in two classes according to their sort
  \begin{itemize}
...
\begin{fact}
  If no function symbol of sort $M^n\times R^m\to R$ occurs in   $t(y;z)$ then 
