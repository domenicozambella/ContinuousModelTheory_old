...
\hfill\texttt{Branch:~semplicissimo \ \DTMnow}\bigskip
\maketitle
\raggedbottom
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
We say that $p(x)\le 0$ is \emph{finitely satisfied (in $uM$)\/} if for every formula $\psi(x)$ that is a disjunction of formulas in $p(x)$, there is an $a\in(uM)^{|x|}$ such that $M\models\psi(a)\le0$.  
