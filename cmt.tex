...
\begin{fact}\label{fact_unifcont}
  ...
  \begin{itemize}
    ...
    \item $\langle{\EuScript M}_i:i\in I\rangle$, a sequence of structures;
    \item $\langle a_i:i\in I\rangle$, a sequence of elements $a_i\in M_i^{|x|}$;
    \item $\langle U_i:i\in I\rangle$, a sequence of open sebsets of $R^n$.
  \end{itemize}
  Let $F$ be an ultrafilter on $I$.
  Assume that for some $\alpha\in R^{|y|}$
  
  \ceq{\hfill\{i\in I : t^{{\EuScript M}_i}( a_i;\alpha)\in U_i\}}{\in}{F.}
...
\begin{lemma}\label{lem_HIapprox}
  ...
  \end{itemize}
  Let $F$ be an ultrafilter on $I$.
  % Let $\alpha=F\mbox{-}\lim_i\alpha_i$.
  Assume that for some $\alpha\in R^{|y|}$

  \ceq{\hfill\{i:{\EuScript M}\models\varphi(a_i;\alpha)\}}{\in}{F.} 

  Then for every $\varphi'>\varphi$ there is  open $V\ni\alpha$ such that for every $\alpha'\in V$
