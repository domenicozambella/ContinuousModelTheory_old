...
we make two semplifications: (1) we only consider ultratpowers; (2) we do not consider formulas in $L$ containing equality, so we need not take any quotient.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{$\mathds{L}$-saturated structures}
