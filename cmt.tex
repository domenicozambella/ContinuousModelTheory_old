...
\begin{definition}\label{def_0}
  ...
  The function symbols of $L'$ are classified in two groups
  \begin{itemize}
...
Our choice of $\mathds{L}$ is not the most general, it is a compromise that accomodates the relevant examples and avoids eccessive complications.
...
The ultrapower construction in Section~\ref{ultrapws} is completely classical w.r.t.\@ functions the first group. 
...
\begin{definition}\label{def_LL}
  Formulas in \emph{$\mathds{L}$\/} are constructed inductively from two groups of formulas below
  \begin{itemize}
