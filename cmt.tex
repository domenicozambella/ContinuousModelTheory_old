...
Let $R$ be some fixed first-order structure which is endowed with a Hausdorff compact topology.
...
Clearly, saturated ${\EuScript L}$-structures exit but, with the exeption of trivial cases (i.e.\@ when $R$ is finite), they are not models.
...
\begin{corollary}\label{prop_tipi_compattezza}
  Let $p(x)\subseteq\mathds{L}(M)$ be finitely consistent in ${\EuScript M}$, a model.
  Then ${\EuScript N}\models\exists x\,p(x)$ for some model ${\EuScript N}$ such that ${\EuScript M}\preceq^\mathds{L}{\EuScript N}$.\hfill\qedsymbol
\end{corollary}
...
\begin{lemma}
  For every $\varphi(x\,;y)\in\mathds{L}(A)$ the set $\varphi(U\,;R)$ is compact.
\end{lemma}

\begin{proof}
  We prove that every finitely intersecting family of closed subsets of $\varphi(U\,;R)$ have nonempty intersection.
  A family of closed subsets of $\varphi(U\,;R)$ has the form
