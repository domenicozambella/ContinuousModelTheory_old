...
\begin{itemize}
  ...
  Though many have been attracted by the challange, this paper we explore an alternative. 
\end{itemize}
...
When possible we borrow results and intuition from nonstandard analysis (i.e.\@ classical model theory).
This clarify the relation between approach (1) and (2) above.
