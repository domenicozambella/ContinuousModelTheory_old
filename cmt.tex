...
Let $R$ be some fixed first-order structure whose domain is the support of a Hausdorff compact topology.
...
\begin{lemma}\label{lem_st}
  Suppose ${\EuScript N}=\langle N,R\rangle$ be a substructure of ${}^*{\EuScript N}=\langle N,{}^*\!R\rangle$, and that $R\preceq{}^*\!R$.
...
\begin{proof}
  ...
  If ${}^*{\EuScript N}\models t(a\,;\alpha)\in C$, then ther are some compact sets $C_i\subseteq R$ such that $C_1\times\dots\times C_n\subseteq C$
  
  \ceq{1.\hfill{}^*{\EuScript N}}
  {\models}
  {t_i(a\,;\alpha)\in C_i.}
...
This proves lemma for a $\mathds{L}$-atomic formula.
