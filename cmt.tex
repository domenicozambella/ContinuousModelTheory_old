...
For $\beta\in R$ we write $\alpha\approx\beta$ if 

\ceq{\hfill{}^*\!R}{\models}{\alpha\in D}\hfill for every $D$ compact neighborhood of $\beta$

and write \emph{$\alpha\approx\alpha'$\/} if $\alpha\approx\beta\approx\alpha'$ for some $\beta\in R$.
From the following it follows that $\,\approx\,$ is an equivalence relation on ${}^*\!R$.
...
\begin{proof}
  ...
  We claim that for every compact $C_i\subseteq R$ such that $C\subseteq C_1\times\dots\times C_{|y|}$

  \ceq{\hfill{\EuScript N}}
  {\models}
  {t_i(a\,;\alpha)\in C_i.}

  By the definition of product topology, $C$ is the intersection of such products as those above.
...
\begin{corollary}\label{prop_tipi_compattezza}
  ...
  Then ${\EuScript N}\models\exists x\,\exists^R y\,p(x\,;y)$ for some model ${\EuScript N}$ such that ${\EuScript M}\preceq^\mathds{L}{\EuScript N}$.\hfill\qedsymbol
\end{corollary}
...
\begin{proof}
  We prove that every finitely intersecting family of closed subsets of $\varphi(U\,;R)$ have nonempty intersection.
