...
\begin{proof}
  ...
  Then $F\mbox{-}\lim_i t^{\EuScript M}(a_i;\alpha)\in C$ by normality of $R$.
  ...
  Vice versa, assime  $\{i:t^{\EuScript M}(a_i\,;\alpha_i)\in D\}\in F$ for every $D$ that is a compact neighborhood of $C$.
  Then, again by normality, $F\mbox{-}\lim_i t^{\EuScript M}(a_i;\alpha_i)\in C$, and (1) follows by Fact~\ref{fact_unifcont}.
  ...
  Then $\big\{i:{\EuScript M}\models\varphi(a_i,b_i\,; \alpha)\big\}\in F$ and, by induction hypothesis, $\big\{ i:{\EuScript M}\models\varphi'(a_i,b_i\,;\alpha_i)\big\}\in F$. 
  A contradiction that proves the implication ($\Rightarrow$) in (1). 
  The converse implication is obtained by contrapprosition from the induction hypothesis.

  To deal with the existential quantifier of sort $M$ we prove 

  \ceq{2.\hfill \{i:{\EuScript M}\models\exists y\,\varphi(a_i,y\,; \alpha)\}\in F}
  {\Leftrightarrow}
  {\big\{ i:{\EuScript M}\models\exists y\,\varphi'(a_i,y\,;\alpha_i)\big\}\in F}\quad for every $\varphi'>\varphi$.
  
  Assume the r.h.s.\@ of the implication and fix $\varphi'>\varphi$. 
  Then there is a sequence $\langle b_i:i\in I\rangle$ such that

  \ceq{}
  { }
  {\big\{ i:{\EuScript M}\models\varphi'(a_i,b_i\,;\alpha_i)\big\}\in F}

  By the induction hypothesis we obtain that $\big\{ i:{\EuScript M}\models\exists y\,\varphi'(a_i,y\,;\alpha_i)\big\}\in F$. 
  As $\varphi'>\varphi$ is arbitrary the implication ($\Rightarrow$) in (2) follows from Proposition~\ref{prop_approx}. 
  ...
  {\Leftrightarrow}
  {\big\{ i:{\EuScript M}\models\varphi'(a_i\,;\alpha_i,\beta_i)\big\}\in F}\quad for every $\varphi'>\varphi$.
  
  We prove

  \ceq{3.\hfill \{i:{\EuScript M}\models\forall^C\!y\,\varphi(a_i\,; \alpha,y)\}\in F}
  {\Leftrightarrow}
  {\big\{ i:{\EuScript M}\models\forall^C\!y\,\varphi'(a_i\,;\alpha_i,y)\big\}\in F}\quad for every $\varphi'>\varphi$.
  ...
  Then $\big\{i:{\EuScript M}\models\varphi(a_i\,; \alpha,\beta)\big\}\in F$ and, by induction hypothesis, $\big\{ i:{\EuScript M}\models\varphi'(a_i\,;\alpha_i,\beta_i)\big\}\in F$. A contradiction that proves the implication ($\Rightarrow$) in (3) . 
  The converse implication is proved similarly by contraposition..

  Finally we prove

  \ceq{4.\hfill \{i:{\EuScript M}\models\exists^C\!y\,\varphi(a_i\,; \alpha,y)\}\in F}
  {\Leftrightarrow}
  {\big\{ i:{\EuScript M}\models\exists^C\!y\,\varphi'(a_i\,;\alpha_i,y)\big\}\in F}\quad for every $\varphi'>\varphi$.
