...
\begin{proof}
  ...
  If $t$ is a function symbol $f$ then $x$ or $y$ do not occur in $t$.
  If $x$ does not occur in $t$ the claim holds because $f^{\EuScript M}:R^{|y|}\to R$ is continuous.
  If $y$ does not occur in $t$ the claim is trivial.
  Finally, induction is clear by the continuity of the functions of sort $R^n\to R$. 
\end{proof}
