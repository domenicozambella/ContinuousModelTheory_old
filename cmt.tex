...
Let $\langle {\EuScript M}_i:i\in I\rangle$ be a sequence of structures, say  ${\EuScript M}_i=\langle \breve M_i,M_i,\mathds{R}\rangle$, that are uniformly bounded.
...
\begin{definition}\label{def_ultraproduct}
  ...
  \begin{itemize}
    \item[1.] $\breve N$ is the set of the sequences $\hat a: I\to\bigcup_{i\in I}\breve M_i$ such that $\hat a\,i\in \breve M_i$.
    \item[2.] $N$ is the set of the sequences $t^{\EuScript N}(\hat a)$ of the form $t^{{\EuScript M}_i}(\hat ai)$, where $t(x)$ is a term of sort $\breve M^n\to M$.
    ...
    $$
    f^{\EuScript N}\big(\hat a,t^{\EuScript N}(\hat c)\big)\ =\ \lim_{i\uparrow F}f^{{\EuScript M}_i}\big(\hat ai,t^{{\EuScript M}_i}(\hat ci)\big).
    $$ 
  \end{itemize}
...
\begin{proof}
  ...
  {=}
  {\lim_{i\uparrow F}\varphi^{\breve M_i}\big(\hat ai,\hat bi\big).}

  We want to prove that

  \ceq{\hfill\Big(\bigwedge_x\varphi\big(\hat a,x\big)\Big)^{\EuScript N}}
  {=}
  {\lim_{i\uparrow F}\Big(\bigwedge_x\varphi\big(\hat ai,x\big)\Big)^{\breve M_i}}
  ...
  {=}
  {\lim_{i\uparrow F}\inf\big\{\varphi\big(\hat ai,b\big)^{\breve M_i}:\,b\in(u\breve M_i)\big\}}
  ...
  \ceq{\textrm{By\ induction\ hypothesis}\hfill\lim_{i\uparrow F}\varphi^{\breve M_i}\big(\hat ai,\hat bi\big)}{<}{\alpha},
  ...
  \ceq{\textrm{Finally,}\hfill\lim_{i\uparrow F}\ \inf\Big\{\varphi^{\breve M_i}\big(\hat ai,b\big):\,b\in(u\breve M_i)\Big\}}{<}{\alpha}.
  ...
  \ceq{\hfill\lim_{i\uparrow F}\inf\Big\{\varphi\big(\hat ai,b\big)^{\breve M_i}:\,b\in(u\breve M_i)^{|x|}\Big\}}
  {<}
  {\alpha.}
  ...
  \ceq{\textrm{Then}\hfill\lim_{i\uparrow F}\varphi^{\breve M_i}\big(\hat ai,\hat bi\big)}{<}{\alpha,}
...
\begin{proof}
  ...
  \ceq{\hfill \varphi^{\EuScript N}\big(\hat a\big)}{=}{\lim_{\xi\uparrow F}\varphi^{\breve M}\big(a_\xi\big).}
