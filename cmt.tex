...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item[3$_i$.] $f_i\big[\neg E_i]=\{0\}$.
  \end{itemize}
  The third condition above is cosmetic and immediate to obtain.
  Finally, let $f=f_1+\dots+f_n$.
\end{proof}
...
\begin{corollary}
  If ${\EuScript A}$ is a $\sigma$-algebra and $\mu$ is a bounded $\sigma$-additive measure then for every $A\in{}^{*\!\!\!}{\EuScript A}$ there are $A_{\rm in},A_{\rm ex}\in{\EuScript A}$ such that $A_{\rm in}\subseteq A\subseteq A_{\rm ex}$ and a measures ${}^{*\!\!}\mu$ such that 
...
\begin{question}
  Assume ${\EuScript A}$ is a $\sigma$-algebra and let $\mu$ be a bounded $\sigma$-additive measure.
  Let ${}^{*\!\!}\mu\in{}^{*\!}{\EuScript M}$ be as above.
  Let $f\in{}^{*\!}{\EuScript R}$ be given.
  We define the function ${}^{\mu\!\!}f:\Omega\to{\mathds R}$ as follows
  $$
  {}^{\mu\!\!}f(a)\ =\ \inf\big\{I(A, f\mu)\,/\mu(A) \ :\ A\in{\EuScript A},\ a\in A,\ \mu(A)>0\big\}
  $$
