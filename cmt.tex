...
The meaning of \emph{${\EuScript M}\models\ \varphi=\psi$\/} and of \emph{$M\,\models\ \varphi<\psi$\/} is similar.
...
In these section we assume the existence of unboundedly many inaccessible cardinals as this simplifies the exposition.
We prove directly the existence of saturated extension (monster models), skipping the proof of the compactness theorem as this yield directly what we need.
...
\begin{proof}
  This is the usual back-and-forth construction with a pinch of extra caution.

  Recall that in a saturated model 
  ...
  As $\psi(b,a)\le0$ and $a,\dots,a\,a_1,\dots,a_n$, we conclude that $\psi(x,a_{i_1})\wedge\dots\wedge\psi(x,a_{i_1})\le0$ is also satisfied.
  The existence of $c$ follwos from saturation.
\end{proof}
