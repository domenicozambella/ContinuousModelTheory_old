...
\begin{itemize}
  ...
  \item [3.] Now we consider an example that is non trivial and distant from classical models as from {\sc bbhu}-models: graphs with weighted verteces and edges.
